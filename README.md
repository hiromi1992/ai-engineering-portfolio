...
コード生成・直接実装には主にCodex / ClaudeなどのCoding Agent（AI実装支援）を活用しています。私は、**AIとの対話を活用しながら、課題整理・要件定義・設計方針・実装指示・検証設計・レビュー・受入 / 再設計を担当**し、コード生成・直接実装はCoding Agentへ委譲しています。
...
コード生成・直接実装にはCoding Agentを活用し、私は**AIとの対話を使いながら、要件・設計方針・テスト観点・レビュー・受入判断**を担当しています。
