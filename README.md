...
**新規事業：約4年｜開発PM：約2年｜AI/Coding Agentを活用したAI Engineering Portfolio：2026年7月〜**

法人営業から新規事業へ領域を広げ、Yagishでは新規事業に約4年従事しました。うち約2年は複数のWebサービスで開発PMを担当し、課題整理、要件定義、画面・仕様設計、優先順位付け、開発推進、QA、リリース判断、リリース後の改善まで担当しています。

2026年7月からは、AI/Coding Agentを実装主体として活用したAI Engineering Portfolioに取り組んでいます。**問題設定、要件、設計方針、検証方法、受入・再設計の判断は自分で行い、コード生成・直接実装はCodex / Claude等へ委譲**しています。
